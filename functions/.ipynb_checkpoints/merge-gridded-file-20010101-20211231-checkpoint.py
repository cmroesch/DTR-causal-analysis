...
ceres= xr.open_dataset('/exports/geos.ed.ac.uk/climate_change/users/carla/ceres/CERES_SYN1deg-Day_Terra-Aqua-MODIS_Ed4.1_Subset_20000301-20221231.nc')
...
merraaod = np.zeros((7670,140,280))*np.nan
claraclt = np.zeros((7670,140,280))*np.nan
...
eobs_all.to_netcdf('/exports/geos.ed.ac.uk/climate_change/users/carla/ceres-clara-merra-eobs27-eobs26-merged-20010101-20211231.nc')
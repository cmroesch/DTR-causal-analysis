...
def causal_grid_box(tn,tx,qq,clt,aod,lat,lon):
    ...
    if np.where(~np.isnan(yr_nan))[0].shape[0] >= 10:
        ...
        np.save('/data/causal-effects-v27-01-14/'+str(lat[0])+'-'+str(lon[0]),results)
...
e = xr.open_dataset('/data/ceres-clara-merra-eobs27-eobs26-merged-20010101-20211231.nc').sel(time = slice('2001-01-01','2014-12-31'))
